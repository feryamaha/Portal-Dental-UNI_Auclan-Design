...
import { getSidebarContent } from '@/data/portals/sidebar-config'
import { getTopbarConfig } from '@/data/portals/topbar-config'
...
export function useDashboardTopbar(params: { portal?: PortalSlug }) {
    ...
    const resolvedPortal: PortalSlug = portal ?? inferPortalFromPathname(pathname)
