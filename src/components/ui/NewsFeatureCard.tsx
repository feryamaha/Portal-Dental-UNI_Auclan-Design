...
export function NewsFeatureCard({ imageSrc, imageAlt, title, date }: NewsFeatureCardProps) {
    return (
        <div className="w-full @Desktop:w-[357px] flex flex-col">
            <div className="h-[190px] overflow-hidden rounded-lg pb-[16px]">
            ...
            <div className="font-inter text-neutral-900">
                <p className="pb-[12px] text-base font-medium">{title}</p>
