...
export function CardMinhasGuias({ title = 'Minhas guias', items, className = '' }: CardMinhasGuiasProps) {
    ...
    return (
        <div
            className={`w-full @Desktop:max-w-[360px] h-[260px] flex-col gap-6 rounded-2xl border border-secondary-100 bg-white p-6 overflow-y-auto scrollbar-none shadow-[0_1px_2px_rgba(0,0,0,0.08)] ${className}`}
        >
